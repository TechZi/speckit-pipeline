...
You are running the cross-tool Spec Kit Pipeline with adapter: claude.
...
If the shared core files are missing, stop and ask the user to run `speckit-pipeline install --tool claude` in the project.
