...
You are running the cross-tool Spec Kit Pipeline with adapter: cursor.
...
If the shared core files are missing, stop and ask the user to run `speckit-pipeline install --tool cursor` in the project.
